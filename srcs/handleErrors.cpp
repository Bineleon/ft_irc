...
void	Server::initErrorMessages() {
	...
	this->_errorMessages[432] = std::make_pair(NICK_ERR, "Erroneus nickname"); // invalid characters in the nickname
	this->_errorMessages[433] = std::make_pair(NICK_ERR, "Nickname is already in use");
	...
	this->_errorMessages[401] = std::make_pair(NICK_ERR, "No such nick");
